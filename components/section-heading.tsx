...
export function SectionHeading({ eyebrow, title, description, centered = true }: SectionHeadingProps) {
  return (
    ...
    >
      <p className="inline-flex rounded-md border border-[#00D1FF]/35 bg-[#00D1FF]/10 px-2.5 py-1 text-[10px] uppercase tracking-[0.2em] text-[#00D1FF]">
        {eyebrow}
      </p>
      <h2 className="neon-title mt-3 text-3xl font-bold leading-[1.05] sm:text-4xl">{title}</h2>
