...
export function Hero({ content }: { content: HeroContent }) {
  return (
    <section id="home" className="relative overflow-hidden pt-20 pb-10 sm:pt-24 sm:pb-12">
      ...
      <div className="container-shell relative grid min-w-0 gap-8 xl:grid-cols-[minmax(0,1fr)_minmax(0,1.12fr)] xl:items-center">
        <motion.div
        ...
        >
          <span className="inline-flex max-w-full rounded-xl border border-[#00FF99]/40 bg-[#00FF99]/10 px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.1em] text-[#00FF99] sm:px-4 sm:text-[11px] sm:tracking-[0.14em]">
            {content.badge}
          </span>

          <h1 className="break-words text-[2.35rem] font-bold leading-[1] text-white min-[380px]:text-4xl sm:text-5xl lg:text-6xl xl:text-[72px]">
          ...
          <p className="max-w-[520px] text-sm leading-relaxed text-[#A6AAB2] sm:text-base lg:text-lg">{content.description}</p>
          ...
          <div className="flex flex-col gap-3 min-[420px]:flex-row min-[420px]:flex-wrap">
            <Button
              ...
              className="h-11 w-full rounded-xl bg-[#00D1A2] px-5 text-sm font-semibold text-black hover:bg-[#54ffd0] min-[420px]:w-auto sm:px-6"
            >
            ...
            <Button
              ...
              variant="outline"
              className="h-11 w-full rounded-xl border-[#00D1FF]/50 bg-[#00D1FF]/10 px-5 text-sm font-semibold text-[#66dfff] hover:bg-[#00D1FF]/20 min-[420px]:w-auto sm:px-6"
            >
              <MessageCircle className="mr-2 h-4 w-4" /> {content.ctaSecondary}
            </Button>
          </div>

          <div className="grid max-w-[340px] grid-cols-3 gap-3 pt-1 sm:gap-4">
            {[
              ["350+", "Installs"],
              ["120+", "Mosques"],
              ["5", "Years"],
              ...
              <div key={item[1]}>
                <p className="text-2xl font-bold text-[#00FF99] drop-shadow-[0_0_12px_rgba(0,255,153,0.7)] sm:text-4xl">
                  {item[0]}
                </p>
                <p className="mt-1 text-[10px] uppercase tracking-[0.12em] text-[#8f95a0] sm:text-[11px] sm:tracking-[0.18em]">{item[1]}</p>
              </div>
            ))}
          </div>
        </motion.div>
        ...
        >
          <div className="glass-panel relative rounded-2xl border-[#00FF99]/35 bg-gradient-to-b from-[#07251d]/70 to-[#080d12]/85 p-3 shadow-[0_0_22px_rgba(0,255,153,0.2)] sm:rounded-3xl sm:p-4">
            <div className="space-y-3 rounded-2xl border border-[#00FF99]/25 bg-[#050607] p-3 sm:p-4">
              ...
              <div className="rounded-xl border border-[#00FF99]/20 bg-[radial-gradient(circle,rgba(255,255,255,0.08)_1px,transparent_1px)] bg-[length:7px_7px] p-4 text-center">
                ...
                <p className="mt-2 break-words font-mono text-2xl font-semibold text-[#00FF99] drop-shadow-[0_0_14px_rgba(0,255,153,0.75)] sm:text-4xl lg:text-5xl">
                  MAGHRIB 06:36 PM
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 min-[420px]:grid-cols-5">
                {[
                  ...
                  <div key={row[0]} className="rounded-lg border border-white/10 bg-[#10141b] p-1.5 text-center sm:p-2">
                    <p className="text-[10px] uppercase tracking-[0.08em] text-[#8b90a0] sm:tracking-[0.12em]">{row[0]}</p>
            ...
            <div className="absolute -bottom-2 right-3 rounded-xl border border-[#00D1FF]/35 bg-[#04131f]/85 px-3 py-1.5 text-[#66dfff] shadow-[0_0_16px_rgba(0,209,255,0.3)] sm:rounded-2xl sm:px-4">
